...
#define STACK_CONSTRUCTOR_ACCOMPLISHED \
  "Stack successfully created and able for the usage."
#define STACK_POP_ACCOMPLISHED "Stack element has successfully popped."
#define STACK_DESTRUCTOR_ACCOMPLISHED \
  "Memory for the stack has successfully freed"
